...
<body>
    <?php
        ...
        if(isset($_POST["submit"])){
            if (empty($_POST["nama"])) {$namaError = "nama tidak boleh kosong";}
            if (empty($_POST["nim"])) {$nimError = "nim tidak boleh kosong";}
            if (empty($_POST["gender"])) {$genderError = "jenis kelamin tidak boleh kosong";}}?>
